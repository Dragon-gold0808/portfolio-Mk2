...
export function Resume({ id, sectionRef, scrollIndicatorHidden, ...rest }) {
  ...
  const education = ["Maintaining  a strong academic performance with a 4.0 unweighted GPA while enrolled in advanced courses.",
  "Pursuing advanced math and science curriculums from Art of Problem Solving. Current courses: Precalculus, AP Physics, and Scientific Computing with Python.",
  "Homeschool courses in subjects including but not limited to British Literature, Spanish II, and Apologetics. Also possesses three years of Latin study and experience with the Institute for Excellence in Writing (IEW).",
  ...
  "Gearing up for participation in academic competitions such as the American Math Competition (AMC 12) and Georgia Tech High School Math Day (HSMD). Also set to undertake a range of Worldwide Online Olympiad Training (WOOT) courses - including Math WOOT, Physics WOOT, Chemistry WOOT, and Code WOOT - through Art of Problem Solving."];

  const projects = [['Developing a small hybrid','rocket engine', 'with variable thrust and thrust vectoring capabilities', 'rocket-engine'],
  ...
  ['Established','Avata', ', a startup streamlining complex event planning and coordination processes.', 'avatar'],
  ...
  const extra = ['Active in Rocketry, Debate, Chess, and Astronomy Clubs.', 'Eagle Scout Candidate in the Boy Scouts.','Participating  in Piano, Jujitsu, Wrestling, and Cross Country.', 'Volunteering with Feed Fannin.', 'Member of the Planetary Society, CERN International Community, and National Society of High School Scholars.'];
            ...
            <div className = {styles.resumeWrapper}>
                <div className={styles.resumeContent}>
                    ...
                    <div className={styles.section}>
                        ...
                        <p className={styles.textContent}>Rising grade 12 high school student with a passion for learning and striving for excellence. Seeking diverse experiences to foster personal and professional growth. Demonstrated abilities include quick learning, unparalleled work ethic, reliability, and keen attention to detail.</p>
                    </div>
